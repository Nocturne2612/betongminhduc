...
/**
 * NewsCategoriesSearch represents the model behind the search form of `backend\models\model\NewsCategories`.
 */
class NewsCategoriesSearch extends NewsCategories
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'meta_title', 'meta_description', 'meta_keyword'], 'safe'],
        ];
    }
