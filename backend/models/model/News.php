...
class News extends \common\models\User {
    ...
    public function getNewsCateParent($parent = null, $level = '') {
        $result = NewsCategories::find()->asArray()->where(['status' => 1, 'parent_id' => $parent])->all();
        ...
        foreach ($result as $key => $value) {
            ...
            $this->getNewsCateParent($value['id'], $level);
        }
        return $this->datas;
    }
