...
<div class="well fillter">
    ...
    <div class="input-group">
        <label class="small">Tên tài khoản</label>
        <?= $form->field($model, 'username')->textInput(['class' => 'form-control', 'type' => 'text'])->label(false); ?>
    </div>
    <div class="input-group">
        <label class="small">Email</label>
        <?= $form->field($model, 'email')->textInput(['class' => 'form-control', 'type' => 'text'])->label(false); ?>
    </div>
    <div class="input-group">
