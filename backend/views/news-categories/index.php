...
/* @var $searchModel backend\models\search\NewsCategoriesSearch */
                    ...
                    <tbody>
                        ...
                        foreach ($datas as $data) {
                            ...
                            <tr class="">
                                ...
                                <td><?= $data['title'] ?></td>
                                <td>
                                    <?= !empty($data['parent_id']) ? NewsCategories::find()->where(['id' => $data['parent_id']])->one()->getAttribute('title') : 'Root' ?>
                                </td>
                                <td align="center">
